...
#ifndef XLNX_ORDER_BOOK_DATA_MOVER_H
#define XLNX_ORDER_BOOK_DATA_MOVER_H
...
class OrderBookDataMover
{


public:
    OrderBookDataMover();
    virtual ~OrderBookDataMover();
...
protected:
    static const uint32_t KERNEL_MEMORY_ARGUMENT_READ_BUFFER_INDEX = 2;
