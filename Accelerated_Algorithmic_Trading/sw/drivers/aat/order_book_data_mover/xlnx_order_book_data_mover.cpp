...
OrderBookDataMover::OrderBookDataMover()
{
...
uint32_t OrderBookDataMover::Initialise(DeviceInterface* pDeviceInterface, const char* cuName)
{
...
uint32_t OrderBookDataMover::Uninitialise(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::CheckIsInitialised(void)
{
	uint32_t retval = XLNX_OK;
...
void OrderBookDataMover::IsInitialised(bool* pbIsInitialised)
{
...
uint32_t OrderBookDataMover::GetCUIndex(uint32_t* pCUIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::GetCUAddress(uint64_t* pCUAddress)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::GetReadBufferCUMemTopologyIndex(uint32_t* pMemTopologyIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::GetWriteBufferCUMemTopologyIndex(uint32_t* pMemTopologyIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::InitialiseRingIndexes(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::StartHWKernel(void)
{
	uint32_t retval = XLNX_OK;
	uint32_t value;
	uint32_t mask;
	...
	if (retval == XLNX_OK)
	{
		...
		retval = WriteRegWithMask32(XLNX_ORDER_BOOK_DATA_MOVER_KERNEL_CONTROL_OFFSET, value, mask);
	}
...
uint32_t OrderBookDataMover::IsHWKernelRunning(bool* pbIsRunning)
{
	uint32_t retval = XLNX_OK;
	uint32_t value;
	...
	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_KERNEL_CONTROL_OFFSET, &value);
	}
...
uint32_t OrderBookDataMover::ReadReg32(uint64_t offset, uint32_t* value)
{
	uint32_t retval = XLNX_OK;
	uint64_t address;
	...
	if (retval != XLNX_OK)
	{
		retval = XLNX_ORDER_BOOK_DATA_MOVER_ERROR_IO_FAILED;
	}
...
uint32_t OrderBookDataMover::WriteReg32(uint64_t offset, uint32_t value)
{
	uint32_t retval = XLNX_OK;
	uint64_t address;
...
uint32_t OrderBookDataMover::WriteRegWithMask32(uint64_t offset, uint32_t value, uint32_t mask)
{
	uint32_t retval = XLNX_OK;
	uint64_t address;
...
uint32_t OrderBookDataMover::BlockReadReg32(uint64_t offset, uint32_t* buffer, uint32_t numWords)
{
	uint32_t retval = XLNX_OK;
	uint64_t address;
...
uint32_t OrderBookDataMover::BlockReadMem32(uint64_t address, uint32_t* buffer, uint32_t numWords)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SetupBufferObjects(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::CleanupBufferObjects(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SetupBufferObjectsFromHostBank(void)
{
	uint32_t retval = XLNX_OK;
	...
	{
		retval = XLNX_ORDER_BOOK_DATA_MOVER_ERROR_FAILED_TO_ALLOCATE_BUFFER_OBJECT;
	}
	...
	if (retval == XLNX_OK)
	{
		...
		if (retval != XLNX_OK)
		{
			retval = XLNX_ORDER_BOOK_DATA_MOVER_ERROR_FAILED_TO_MAP_BUFFER_OBJECT;
		}
	}
...
uint32_t OrderBookDataMover::SetupBufferObjectsFromCardRAM(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SetHWReadBufferAddress(uint64_t address)
{
	uint32_t retval = XLNX_OK;
	uint32_t upperWord;
	uint32_t lowerWord;
	...
	retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_READ_BUFFER_ADDRESS_LOWER_WORD_OFFSET, lowerWord);
	
	
	if (retval == XLNX_OK)
	{
		retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_READ_BUFFER_ADDRESS_UPPER_WORD_OFFSET, upperWord);
	}
...
uint32_t OrderBookDataMover::SetHWWriteBufferAddress(uint64_t address)
{
	uint32_t retval = XLNX_OK;
	uint32_t upperWord;
	uint32_t lowerWord;
	...
	retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_WRITE_BUFFER_ADDRESS_LOWER_WORD_OFFSET, lowerWord);


	if (retval == XLNX_OK)
	{
		retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_WRITE_BUFFER_ADDRESS_UPPER_WORD_OFFSET, upperWord);
	}
...
uint32_t OrderBookDataMover::CleanupBufferObjectsFromHostBank(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::CleanupBufferObjectsFromCardRAM(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SetupBuffersIfNecessary(void)
{
	uint32_t retval = XLNX_OK;
...
void* OrderBookDataMover::GetReadBufferHostVirtualAddress(void)
{
	return m_readBufferHostVirtualAddress;
}


uint64_t OrderBookDataMover::GetReadBufferHWAddress(void)
{
...
uint32_t OrderBookDataMover::SyncReadBuffer(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SyncReadBufferInternal(void)
{
	uint32_t retval = XLNX_OK;
		...
		if (m_bUsingHostBank == false)
		{
			...
			if (currentTailIndex > m_lastReadTailIndex)
			{
				...
				while (totalTransferredElements < totalNewElements)
				{
					...
					{
						retval = XLNX_ORDER_BOOK_DATA_MOVER_ERROR_FAILED_TO_SYNC_BUFFER_OBJECT;
						break; //out of loop
					}
				}
...
uint32_t OrderBookDataMover::GetHWRingReadBufferIndexes(uint32_t* pHeadIndex, uint32_t* pTailIndex)
{
	uint32_t retval = XLNX_OK;

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_RING_READ_BUFFER_HEAD_INDEX_OFFSET, pHeadIndex);
	}


	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_RING_READ_BUFFER_TAIL_INDEX_OFFSET, pTailIndex);
	}
...
uint32_t OrderBookDataMover::GetSWRingReadBufferIndexes(uint32_t* pHeadIndex, uint32_t* pTailIndex)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SetHWRingReadHeadIndex(uint32_t headIndex)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_RING_READ_BUFFER_HEAD_INDEX_OFFSET, headIndex);
	}
...
uint32_t OrderBookDataMover::GetStats(Stats* pStats)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_TX_RESPONSE_INDEX_OFFSET, &(pStats->txResponseCount));
	}

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_NUM_RX_OP_OFFSET, &(pStats->rxOp));
	}
...
// latency counters
uint32_t OrderBookDataMover::GetLatencyStats(uint32_t durationSeconds, double* max, double* min, double* sum, uint32_t* cnt, uint32_t* cyclesPre, uint32_t* cyclesPost)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		...
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_CYCLES_PRE_OFFSET, &val);	
	...
	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_LATENCY_MIN_OFFSET, &val);
	    *min = (double)val * (double)multiplier / (double)clockFrequencyMHz;
	}

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_LATENCY_MAX_OFFSET, &val);
	    *max = (double)val * (double)multiplier / (double)clockFrequencyMHz;
	}

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_LATENCY_SUM_OFFSET, &val);
	    *sum = (double)val * (double)multiplier / (double)clockFrequencyMHz;
	}

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_LATENCY_CNT_OFFSET, cnt);
	}
	...
	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_CYCLES_POST_OFFSET, &val);
...
uint32_t OrderBookDataMover::StartLatencyCounters(void)
{
    uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{	
		retval = WriteRegWithMask32(XLNX_ORDER_BOOK_DATA_MOVER_CTRL_OFFSET, 0x04, 0x04);
	}
	...
	if (retval == XLNX_OK)
	{
		retval = WriteRegWithMask32(XLNX_ORDER_BOOK_DATA_MOVER_CTRL_OFFSET, 0x00, 0x04);
	}
	...
	if(retval == XLNX_OK)
	{ 	
		retval = WriteRegWithMask32(XLNX_ORDER_BOOK_DATA_MOVER_CTRL_OFFSET, 0x02, 0x02);
	}
	return 0;
}
...
uint32_t OrderBookDataMover::StopLatencyCounters(void)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = WriteRegWithMask32(XLNX_ORDER_BOOK_DATA_MOVER_CTRL_OFFSET, 0x00, 0x02);
	}
...
void* OrderBookDataMover::GetWriteBufferHostVirtualAddress(void)
{
...
uint64_t OrderBookDataMover::GetWriteBufferHWAddress(void)
{
...
uint32_t OrderBookDataMover::SyncWriteBuffer(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::SyncWriteBufferInternal(void)
{
	uint32_t retval = XLNX_OK;
...
uint32_t OrderBookDataMover::GetHWRingWriteBufferIndexes(uint32_t* pHeadIndex, uint32_t* pTailIndex)
{
	uint32_t retval = XLNX_OK;

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_RING_WRITE_BUFFER_HEAD_INDEX_OFFSET, pHeadIndex);
	}


	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_RING_WRITE_BUFFER_TAIL_INDEX_OFFSET, pTailIndex);
	}
...
uint32_t OrderBookDataMover::GetSWRingWriteBufferIndexes(uint32_t* pHeadIndex, uint32_t* pTailIndex)
{
	uint32_t retval = XLNX_OK;
...
void OrderBookDataMover::SetSWWriteTailIndex(uint32_t tailIndex)
{
...
uint32_t OrderBookDataMover::SetHWWriteTailIndex(uint32_t tailIndex)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_RING_WRITE_BUFFER_TAIL_INDEX_OFFSET, tailIndex);
	}
...
uint32_t OrderBookDataMover::SetThrottleRate(uint32_t throttleRateClockCycles)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = WriteReg32(XLNX_ORDER_BOOK_DATA_MOVER_THROTTLE_RATE_OFFSET, throttleRateClockCycles);
	}
...
uint32_t OrderBookDataMover::GetThrottleRate(uint32_t* pThrottleRateClockCycles)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_THROTTLE_RATE_OFFSET, pThrottleRateClockCycles);
	}
...
uint32_t OrderBookDataMover::GetThrottleStats(ThrottleStats* pStats)
{
	uint32_t retval = XLNX_OK;
	...
	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_THROTTLE_COUNT_OFFSET, &(pStats->throttleCounter));
	}

	if (retval == XLNX_OK)
	{
		retval = ReadReg32(XLNX_ORDER_BOOK_DATA_MOVER_TROTTLE_EVENT_OFFSET, &(pStats->throttleEvents));
	}
...
void OrderBookDataMover::GetDMAStats(DMAStats* pH2CStats, DMAStats* pC2HStats)
{
...
void OrderBookDataMover::ResetDMAStats(void)
{
...
void OrderBookDataMover::DMAStatsLogWrapAround(DMAStats* pStats)
{
	pStats->bufferWrapArounds++;
}


void OrderBookDataMover::DMAStatsLogTransfer(DMAStats* pStats, uint32_t size)
{
...
void OrderBookDataMover::SetDMAChunkSize(uint32_t numElements)
{
...
void OrderBookDataMover::GetDMAChunkSize(uint32_t* pNumElements)
{
...
void OrderBookDataMover::SetHWEmulationPollDelay(uint32_t delaySeconds)
{
	m_hwEmulationPollDelaySeconds = delaySeconds;
}


void OrderBookDataMover::GetHWEmulationPollDelay(uint32_t* pDelaySeconds)
{
