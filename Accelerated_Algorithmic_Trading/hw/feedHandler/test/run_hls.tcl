...
add_files "${KERNEL_ROOT}/feedhandler.cpp" -cflags ${CFLAGS}
add_files "${KERNEL_ROOT}/feedhandler_top.cpp" -cflags ${CFLAGS}
add_files -tb "tb_feedhandler.cpp" -cflags "-I${KERNEL_ROOT} ${CFLAGS}"
