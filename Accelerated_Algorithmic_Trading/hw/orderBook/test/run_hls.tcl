...
add_files "${KERNEL_ROOT}/orderbook.cpp" -cflags ${CFLAGS}
add_files "${KERNEL_ROOT}/orderbook_top.cpp" -cflags ${CFLAGS}
add_files -tb "tb_orderbook.cpp" -cflags "-I${KERNEL_ROOT} ${CFLAGS}"
