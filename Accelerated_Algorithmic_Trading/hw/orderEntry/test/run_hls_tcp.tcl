...
add_files "${KERNEL_ROOT}/orderentry.cpp" -cflags ${CFLAGS}
add_files "${KERNEL_ROOT}/orderentry_tcp_top.cpp" -cflags ${CFLAGS}
add_files -tb "tb_orderentry_tcp.cpp" -cflags "-I${KERNEL_ROOT} ${CFLAGS}"
